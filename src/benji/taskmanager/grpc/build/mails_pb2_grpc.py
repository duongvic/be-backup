...
from benji.taskmanager.grpc.build import mail_types_pb2 as mail__types__pb2
...
class MailServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.send_full_storage_issue = channel.unary_unary(
                '/mails.MailService/send_full_storage_issue',
                request_serializer=mail__types__pb2.FullStorageIssue.SerializeToString,
                response_deserializer=mail__types__pb2.MailReply.FromString,
                )
...
class MailServiceServicer(object):
    ...
    def send_full_storage_issue(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MailServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'send_full_storage_issue': grpc.unary_unary_rpc_method_handler(
                    servicer.send_full_storage_issue,
                    request_deserializer=mail__types__pb2.FullStorageIssue.FromString,
                    response_serializer=mail__types__pb2.MailReply.SerializeToString,
            ),
    }
...
class MailService(object):
    ...
    @staticmethod
    def send_full_storage_issue(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mails.MailService/send_full_storage_issue',
            mail__types__pb2.FullStorageIssue.SerializeToString,
            mail__types__pb2.MailReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

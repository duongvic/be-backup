...
def main():
    ...
    # seed database
    p = subparsers_root.add_parser('database-seed', help='Seed data from db Miq')
    p.set_defaults(func='db_seed')

    # Stress Test
    p = subparsers_root.add_parser('stress-test', help='Do stress test')
    p.set_defaults(func='do_stress_test')
    ...
    p.add_argument('-a', '--bind-address', default='0.0.0.0', help='Bind to the specified IP address')
    p.add_argument('-p', '--bind-port', default=5000, type=int, help='Bind to the specified port')
